...
class StyleColors:
    ...
    THREE_DIM_FIB_COLOR = "#eb70a9"
    THREE_DIM_ELLIPSE_COLOR = "#2EA2EC"
...
class ApplicationText:
    ...
    WINDOW_TITLE = "ASV Spin Mill Angle Calculator 2.3"
...
class ToolTips:
    ...
    TARGET_MILLING_ANGLE_LABEL = "The milling angle set in Auto Slice And View (ASV)."

    AOI_DIAMETER_LABEL = "The diameter of the area of interest (AOI) circle set in Auto Slice And View (ASV)."

    MEASURED_HEIGHT_ELLIPSE_LABEL = "The height of the AOI ellipse measured from the perspective of the FIB."
...
class LabelStyles:
    ...
    @staticmethod
    def result() -> str:
        """Read-only result display label with subtle background."""
        return f"""
            QLabel {{
                color: {StyleColors.TEXT_PRIMARY};
                font-size: {StyleDimensions.FONT_SIZE_NORMAL};
    ...
    @staticmethod
    def legend() -> str:
        """Transparent label used in plot legend rows."""
        return f"""
            QLabel {{
                color: {StyleColors.TEXT_PRIMARY};
                font-size: {StyleDimensions.FONT_SIZE_NORMAL};
...
class ButtonStyles:
    ...
    @staticmethod
    def toggle() -> str:
        """ Style for toggle buttons (plot buttons)."""
        return f"""
            QPushButton {{
                background-color: {StyleColors.BUTTON_BG};
                color: {StyleColors.TEXT_PRIMARY};
            ...
            QPushButton:hover {{
                /*color: {StyleColors.TEXT_PRIMARY};*/
                border: 1px solid {StyleColors.TEXT_PRIMARY};
            }}
            QPushButton:pressed {{
                background-color: {StyleColors.BUTTON_PRESSED};
                color: {StyleColors.TEXT_PRIMARY};
