...
class TwoDimCanvas(FigureCanvasQTAgg):
    ...
    def _apply_canvas_plot_style(self):
        ...
        for spine in self.ax.spines.values():
            spine.set_edgecolor(AppStyles.Colors.THREE_DIM_LABEL_COLOR)
        # Set tick colors
        self.ax.tick_params(colors=AppStyles.Colors.THREE_DIM_LABEL_COLOR)
    ...
    def clear(self):
        ...
        self.ax.clear()
        self._apply_canvas_plot_style()
        # Explicitly turn off grid after clearing
        self.ax.grid(False)
    ...
    def plot_ccd_view(self, calculated_angle, diameter,
        ...
        self.ax.text(text_x, text_z, f'{calculated_angle:.2f}°',
                     ...
                     #           facecolor=AppStyles.Colors.GROUPBOX_GB,
                     #           edgecolor=AppStyles.Colors.GROUPBOX_GB,
                     #           linewidth=1)
                    )

        # Configure display - remove µm from Z axis
        self.set_labels('X (µm)', 'Z')
        self.set_title('CCD View', fontsize=12)
        self.set_grid(False)
    ...
    def plot_fib_view(self, diameter, measured_minor,
        ...
        # Configure display
        self.set_labels('X (µm)', 'Y (µm)')
        self.set_title('FIB View', fontsize=12)
        self.set_grid(False)
